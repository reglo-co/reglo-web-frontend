...
export function GripAndHover({ children, isDragging, handleProps }: Props) {
  return (
    <div
      ...
      className="data-[is-dragging=true]:ring-opacity-50 group w-full rounded-md transition-all duration-200 data-[is-dragging=false]:opacity-100 data-[is-dragging=true]:relative data-[is-dragging=true]:z-[9999] data-[is-dragging=true]:opacity-60 data-[is-dragging=true]:shadow-lg data-[is-dragging=true]:ring-2 data-[is-dragging=true]:ring-black/50"
    >
